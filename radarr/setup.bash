...
parallel ::: \
  ...
  'echo "Download AutoConfig service..." && curl -sfL https://raw.githubusercontent.com/RandomNinjaAtk/arr-scripts/main/radarr/AutoConfig.service -o /custom-services.d/AutoConfig && echo "Done"' \
  'echo "Download AutoExtras service..." && curl -sfL https://raw.githubusercontent.com/RandomNinjaAtk/arr-scripts/main/radarr/AutoExtras.service -o /custom-services.d/AutoExtras && echo "Done"' \
  'echo "Download InvalidMoviesAutoCleaner service..." && curl -sfL https://raw.githubusercontent.com/RandomNinjaAtk/arr-scripts/main/radarr/InvalidMoviesAutoCleaner.bash -o /custom-services.d/InvalidMoviesAutoCleaner && echo "Done"' \
  'echo "Download UnmappedFolderCleaner service..." && curl -sfL https://raw.githubusercontent.com/RandomNinjaAtk/arr-scripts/main/radarr/UnmappedFolderCleaner.bash -o /custom-services.d/UnmappedFolderCleaner && echo "Done"' \
...
if [ ! -f /config/extended/naming.json ]; then
  echo "Download Naming script..." && curl -sfL https://raw.githubusercontent.com/RandomNinjaAtk/arr-scripts/main/radarr/naming.json -o /config/extended/naming.json && echo "Done"
fi

echo "Download PlexNotify script..." && curl -sfL https://raw.githubusercontent.com/RandomNinjaAtk/arr-scripts/main/radarr/PlexNotify.bash -o /config/extended/PlexNotify.bash && echo "Done"
echo "Download Extras script..." && curl -sfL https://raw.githubusercontent.com/RandomNinjaAtk/arr-scripts/main/radarr/Extras.bash -o /config/extended/Extras.bash && echo "Done"
echo "Download TdarrScan script..." && curl -sfL https://raw.githubusercontent.com/RandomNinjaAtk/arr-scripts/main/radarr/TdarrScan.bash -o /config/extended/TdarrScan.bash && echo "Done"

if [ ! -f /config/extended/sma.ini ]; then
  echo "Download SMA config..." && curl -sfL https://raw.githubusercontent.com/RandomNinjaAtk/arr-scripts/main/radarr/sma.ini -o /config/extended/sma.ini && echo "Done"
fi

if [ ! -f /config/extended/recyclarr.yaml ]; then
  echo "Download Recyclarr config..." && curl -sfL https://raw.githubusercontent.com/RandomNinjaAtk/arr-scripts/main/radarr/recyclarr.yaml -o /config/extended/recyclarr.yaml && echo "Done"
fi

if [ ! -f /config/extended.conf ]; then
  echo "Download Extended config..." && curl -sfL https://raw.githubusercontent.com/RandomNinjaAtk/arr-scripts/main/radarr/extended.conf -o /config/extended.conf && echo "Done"
fi
